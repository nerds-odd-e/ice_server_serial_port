...
# ADD LINK32 Ice.lib IceUtil.lib Glacier2.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"server.exe" /libpath:"../../../lib" /FIXED:no
...
# ADD LINK32 Iced.lib IceUtild.lib Glacier2d.lib /nologo /subsystem:console /debug /machine:I386 /out:"server.exe" /pdbtype:sept /libpath:"../../../lib" /FIXED:no
