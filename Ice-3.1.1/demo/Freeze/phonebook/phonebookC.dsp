...
# ADD LINK32 Freeze.lib Ice.lib IceUtil.lib /nologo /subsystem:console /pdb:none /machine:I386 /out:"client.exe" /libpath:"../../../lib" /FIXED:no
...
#xxx#
#xxx#!IF  "$(CFG)" == "phonebookC - Win32 Release"
#xxx#
...
#xxx#
#xxx#!ELSEIF  "$(CFG)" == "phonebookC - Win32 Debug"
#xxx#
#xxx## Begin Custom Build
#xxx#InputPath=.\Grammar.y
#xxx#
