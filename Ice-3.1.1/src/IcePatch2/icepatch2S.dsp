...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /O2 /I "." /I ".." /I "../../include" /D "_CONSOLE" /D "NDEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /c
...
# ADD LINK32 setargv.obj /nologo /subsystem:console /pdb:none /machine:I386 /out:"Release/icepatch2server.exe" /FIXED:no
...
# ADD LINK32 setargv.obj /nologo /subsystem:console /debug /machine:I386 /out:"Debug/icepatch2server.exe" /pdbtype:sept /FIXED:no
