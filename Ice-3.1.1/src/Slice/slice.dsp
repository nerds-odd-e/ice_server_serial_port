...
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\slice31.dll ..\..\bin	copy $(OutDir)\slice.lib ..\..\lib
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/slice31d.dll" /implib:"Debug/sliced.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\sliced.lib ..\..\lib	copy $(OutDir)\slice31d.pdb ..\..\bin	copy $(OutDir)\slice31d.dll ..\..\bin
# End Special Build Tool
