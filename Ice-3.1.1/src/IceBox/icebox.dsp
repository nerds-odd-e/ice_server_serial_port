...
# ADD LINK32 /nologo /dll /pdb:none /machine:I386 /out:"Release/icebox31.dll" /implib:"Release/icebox.lib" /FIXED:no
# SUBTRACT LINK32 /debug
# Begin Special Build Tool
OutDir=.\Release
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\icebox.lib ..\..\lib	copy $(OutDir)\icebox31.dll ..\..\bin
...
# ADD CPP /nologo /MDd /W3 /WX /Gm /GR /GX /Zi /Od /I ".." /I "../../include" /D "_USRDLL" /D "ICE_BOX_API_EXPORTS" /D "_CONSOLE" /D "_DEBUG" /D "WIN32_LEAN_AND_MEAN" /FD /GZ /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /dll /debug /machine:I386 /out:"Debug/icebox31d.dll" /implib:"Debug/iceboxd.lib" /FIXED:no
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
OutDir=.\Debug
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(OutDir)\iceboxd.lib ..\..\lib	copy $(OutDir)\icebox31d.pdb ..\..\bin	copy $(OutDir)\icebox31d.dll ..\..\bin
# End Special Build Tool
